...
opts_1.DataRange = 'I2:I19'; %'B2:B21'; %with outliers
per_subj_box_plot_data = readmatrix('classification_results.xlsx',opts_1);
...
axis_1 = gca;
axis_1.Title.String = '4C\_mean\_acc per subject';
...
axis_1.XTick = 1;
axis_1.XTickLabel = {'18'};

%boxWidth = 2;
boxes = findobj(axis_1, 'Tag', 'Box');

for i = 1:length(boxes)
    p = patch(get(boxes(i), 'XData'), get(boxes(i), 'YData'), [1, 0 , 0], 'FaceAlpha', 1);
end
